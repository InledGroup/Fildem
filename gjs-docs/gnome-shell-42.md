...
### Session Modes [​](./gnome-shell-42.md)

GNOME Shell 42 added support for the [`session-modes`](./anatomy.md) field in `metadata.json`.
...
*   Extensions with `"session-modes"` can only pass the EGO reviews if they meet [the review guidelines requirements related to the session modes](./review-guidelines.md).
    

Extension [​](./gnome-shell-42.md)
-----------------------------------------------------------------------------------
...
### `buildPrefsWidget()` [​](./gnome-shell-42.md)
...
### `fillPreferencesWindow()` [​](./gnome-shell-42.md)
...
### Test Preferences Window in Dark and Light mode [​](./gnome-shell-42.md)
...
### Resize Preferences Window [​](./gnome-shell-42.md)
...
### Enable Search in Preferences Window [​](./gnome-shell-42.md)
...
GNOME Shell [​](./gnome-shell-42.md)
---------------------------------------------------------------------------------------

### Signals [​](./gnome-shell-42.md)
...
### Desktop [​](./gnome-shell-42.md)

#### Color scheme [​](./gnome-shell-42.md)
...
#### Workspace Switcher Popup [​](./gnome-shell-42.md)
...
### Top Panel [​](./gnome-shell-42.md)

#### Panel Corner [​](./gnome-shell-42.md)

`ui.panel.PanelCorner` class and `.panel-corner` style class no longer exist in GNOME Shell 42.

#### Popup Menu Section [​](./gnome-shell-42.md)
