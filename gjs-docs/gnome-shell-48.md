...
GNOME Shell [​](./gnome-shell-48.md)
---------------------------------------------------------------------------------------

### Custom Logger [​](./gnome-shell-48.md)
...
### `InputSourceManager` [​](./gnome-shell-48.md)
...
### `WindowManager` [​](./gnome-shell-48.md)
...
### St Widgets Orientation [​](./gnome-shell-48.md)
...
### Time Limit and Break Manager [​](./gnome-shell-48.md)
...
### Notifications Per App Group [​](./gnome-shell-48.md)
...
GJS [​](./gnome-shell-48.md)
-----------------------------------------------------------------------

### `Clutter.Image` [​](./gnome-shell-48.md)
...
### `Clutter.Stage.get_key_focus()` [​](./gnome-shell-48.md)
