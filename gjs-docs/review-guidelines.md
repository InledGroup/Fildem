...
GNOME Shell Extensions Review Guidelines [​](./review-guidelines.md)
------------------------------------------------------------------------------------------------------------------------------------------------------------

TIP

If this is your first time writing an extension, please see the [Getting Started](./getting-started.md) guide.
...
General Guidelines [​](./review-guidelines.md)
----------------------------------------------------------------------------------------------------------------
...
Rules [​](./review-guidelines.md)
--------------------------------------------------------------------------------------

### Only use initialization for static resources [​](./review-guidelines.md)
...
### Destroy all objects [​](./review-guidelines.md)
...
### Disconnect all signals [​](./review-guidelines.md)
...
### Remove main loop sources [​](./review-guidelines.md)
...
### Do not use deprecated modules [​](./review-guidelines.md)
...
### Do not import GTK libraries in GNOME Shell [​](./review-guidelines.md)
...
### Do not import GNOME Shell libraries in Preferences [​](./review-guidelines.md)
...
### Avoid interfering with the Extension System [​](./review-guidelines.md)
...
### Code must not be obfuscated [​](./review-guidelines.md)
...
### No excessive logging [​](./review-guidelines.md)
...
### Extensions should not force dispose a GObject [​](./review-guidelines.md)
...
### Scripts and Binaries [​](./review-guidelines.md)
...
### Clipboard Access must be declared [​](./review-guidelines.md)
...
### Privileged Subprocess must not be user-writable [​](./review-guidelines.md)
...
### Extensions must be functional [​](./review-guidelines.md)
...
### Extensions must not be AI-generated [​](./review-guidelines.md)
...
### metadata.json must be well-formed [​](./review-guidelines.md)
...
This **MUST** only contain [possible keys](./anatomy.md) and **MUST** be dropped if you don't use any of the keys.
...
### Session Modes [​](./review-guidelines.md)
...
### GSettings Schemas [​](./review-guidelines.md)
...
### Do not use telemetry tools [​](./review-guidelines.md)

Extensions **MUST NOT** use any telemetry tools to track users and share the user data online.

Legal Restrictions [​](./review-guidelines.md)
----------------------------------------------------------------------------------------------------------------

### Code of Conduct [​](./review-guidelines.md)
...
### Political Statements [​](./review-guidelines.md)
...
### Licensing [​](./review-guidelines.md)
...
### Copyrights and Trademarks [​](./review-guidelines.md)
...
Recommendations [​](./review-guidelines.md)
----------------------------------------------------------------------------------------------------------

### Don't include unnecessary files [​](./review-guidelines.md)
...
### Use a linter [​](./review-guidelines.md)
...
### UI Design [​](./review-guidelines.md)
...
Getting Help [​](./review-guidelines.md)
----------------------------------------------------------------------------------------------------
