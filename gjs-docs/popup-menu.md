...
The [`PopupMenu`](https://gitlab.gnome.org/GNOME/gnome-shell/-/tree/main/js/ui/popupMenu.js) module contains classes for creating popup menus in GNOME Shell. Extension authors often use these with panel buttons and [Quick Settings](./quick-settings.md).

Menu Items [​](./popup-menu.md)
------------------------------------------------------------------------------

### `Ornament` [​](./popup-menu.md)
...
### `PopupBaseMenuItem` [​](./popup-menu.md)
...
*   `setOrnament(ornament)` — Sets the ornament for the item
    *   ornament (`PopupMenu.Ornament`) — A [`PopupMenu.Ornament`](./popup-menu.md)

#### Properties [​](./popup-menu.md)
...
### `PopupMenuItem` [​](./popup-menu.md)

Parent Class: [`PopupMenu.PopupBaseMenuItem`](./popup-menu.md)
...
### `PopupImageMenuItem` [​](./popup-menu.md)
...
### `PopupSeparatorMenuItem` [​](./popup-menu.md)
...
### `PopupSwitchMenuItem` [​](./popup-menu.md)
...
### `PopupSubMenuMenuItem` [​](./popup-menu.md)
...
### `PopupMenu` [​](./popup-menu.md)

Parent Class: [`PopupMenu.PopupMenuBase`](./popup-menu.md)
...
### `PopupMenuSection` [​](./popup-menu.md)
...
### `PopupSubMenu` [​](./popup-menu.md)

Parent Class: [`PopupMenu.PopupMenuBase`](./popup-menu.md)

This menu should typically only be used indirectly, by creating a [`PopupSubMenuMenuItem`](./popup-menu.md).
