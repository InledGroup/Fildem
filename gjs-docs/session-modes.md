...
Since GNOME 42, extensions have the option of operating in other session modes, such as the `unlock-dialog` mode when the screen is locked. For more details, see the [`session-modes`](./anatomy.md) documentation.

#### See Also [​](./session-modes.md)
...
Example Usage [​](./session-modes.md)
---------------------------------------------------------------------------------------
